...
<body>
    ...
    <form action="confirmation.php" method="get" class="form flex">
      ...
      <section class="button-operations">
        <button class="go-back" name="cancel" value="cancel">Cancel</button>
      </section>
    </form>
...
document.querySelectorAll('.seats-button').forEach(button => {
    button.addEventListener('click', function() {
        ...
        if (clickedValues.includes(value)) {
            ...
            clickedValues = clickedValues.filter(item => item !== value);
            // Remove the CSS class to indicate the button has been unclicked
