<x-layout>
    ...
    <section>
        ...
        <section class="p-8 pb-0 flex flex-wrap justify-center gap-8">
            ...
            <x-admin.card-movie img="resources/icons/assign-white.svg" title="Cinema Assignment" href="/admin/cinema-assignment" />
            <x-admin.card-movie img="resources/icons/update-white.svg" title="Update Status" href="/admin/update-status" />
        </section>
    </section>
    ...
    <section>
        ...
        <section class="p-8 pb-0 flex flex-wrap justify-center gap-8">
            <x-admin.card-movie img="resources/icons/pay-white.svg" title="Paid Tickets History" href="/admin/paid-history" />
            <x-admin.card-movie img="resources/icons/add-user-white.svg" title="Add a User" href="/admin/create-user" />
            <x-admin.card-movie img="resources/icons/registered-white.svg" title="Registered Users" href="/admin/register-index" />
